...
import LogoWhite from './../assets/image/4.png';
...
<nav className={`uk-navbar-transparent ${navBarStyle}`} uk-navbar="true">
    <div className="uk-navbar-left">
        <ul className="uk-navbar-nav uk-margin-left ">
            <li>
                <Link to="/">
                    <img className="uk-margin-small" src={isBlack ? LogoWhite : Logo} width="170px" alt=""/>
                </Link>
            </li>
        </ul>
    </div>
    ...
    <div className="uk-navbar-right">
        <ul className="uk-navbar-nav">
            ...
            <div className="uk-navbar-item item-navbar">
                <Link to="/Login" className={`uk-button uk-text-capitalize ${textStyle}`} >Entrar</Link>
            </div>
